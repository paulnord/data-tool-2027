...
The source repository and distributable applications serve different audiences. Users should receive a direct browser link or an installer download, without having to build the source.
