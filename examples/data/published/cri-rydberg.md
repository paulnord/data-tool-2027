...
[Data file](cri-rydberg.csv) · [Example documentation index](README.md) · [Publication](https://doi.org/10.1016/j.rinp.2025.108368)
...
Fix RM = 109736.157 cm⁻¹. The custom equation below gives IP = 54575.481261 ± 0.023707 cm⁻¹, delta0 = 2.5516326 ± 0.0048868 and a = −9.670963 ± 1.582712. The publication reports IP = 54575.49 ± 0.02 (statistical) ± 0.03 (systematic), delta0 = 2.552 ± 0.004 and a = −9.9 ± 1.3, with reduced χ² = 0.6315. Our reduced χ² is 0.621867.
...
The configured session and independent reference both fix RM = 109736.157 cm⁻¹. Rounded starting values still converge to the same solution. The fixed constant's precision does not explain the small differences from the publication.
...
Equation: `IP-RM/(n-(delta0+a/(n-delta0)^2))^2`. X: column 1 (`n`); Y: column 2; Y standard deviation: column 3.

Starting values: `IP = 54575.49`, `RM = 109736.157` (fixed), `delta0 = 2.552`, `a = -9.9`.
...
| RM | 109736.157 | fixed |
| delta0 | 2.551632593 | 0.0048867828 |
