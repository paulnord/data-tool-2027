# PWN luminosity versus spin-down power

[Data file](published-pwn-luminosity-vs-edot.csv) · [Example documentation index](published-examples.md) · [Publication](https://doi.org/10.1093/mnras/stab025)
